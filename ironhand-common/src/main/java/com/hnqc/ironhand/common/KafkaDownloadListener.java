...
@Component
public class KafkaDownloadListener {
    ...
    private static Logger logger = LoggerFactory.getLogger(KafkaDownloadListener.class);

    @Autowired
    public KafkaDownloadListener(IFileService fileService, IDownloadService downloadService) {
